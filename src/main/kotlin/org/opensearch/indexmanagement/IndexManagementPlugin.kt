...
class IndexManagementPlugin : JobSchedulerExtension, NetworkPlugin, ActionPlugin, ExtensiblePlugin, SystemIndexPlugin,
    ...
    private lateinit var indexOperationActionFilter: IndexOperationActionFilter
    ...
    override fun createComponents(
        ...
        ISMActionsMetrics.instance.initialize(metricsRegistry)
        ...
        val managedIndexRunner =
            ManagedIndexRunner
                ...
                .registerMetricRegistry(metricsRegistry)
